...
def get_layering_recs():
    ...
    prompt = (f"""
        For each of these perfumes: {perfumes}, return their top, middle, and base notes in a JSON format like this:
        ...
        Please return **only** valid JSON with no extra commentary or text.""")
